...
transData = transportationMode[selectedMode];
  ...
  // Write to page
    ...
    "<p>By "+transData[2]+" for just "+transitTime+" minutes on your next trip:</p><p><strong>You can eat "+donuts+" donuts and save "+treeDays+" tree-days<sup>*</sup> worth of CO<sub>2</sub>!</strong></p>";
}
